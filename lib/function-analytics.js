...
function (_Fetcher) {
  ...
  function Analytics() {
    ...
    _this.postProcess(function (data) {
      return _this.standardizeAnalytics(data, oldAnalytics);
    });
