...
function () {
  ...
  _createClass(Runner, [{
    key: "all",
    value: function all(executions) {
      var promises = executions.map(function (execution) {
