...
function () {
  ...
  _createClass(Processor, [{
    key: "dependsOn",
    value: function dependsOn(callback) {
      return this;
    }
  }, {
    key: "process",
    ...
    key: "performProcess",
    value: function performProcess(data) {
      var dataToProcess = data;
      this.resultProcessors.forEach(function (callback) {
